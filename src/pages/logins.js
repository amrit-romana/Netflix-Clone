...
function Logins() {
  ...
  return (
    <div className='logins'>
     ...
     <img src="https://assets.stickpng.com/images/580b57fcd9996e24bc43c529.png" className='logins_logo'/>
      <button className='logins_button' onClick={()=> setsignIN(true)}>Sign In</button>
